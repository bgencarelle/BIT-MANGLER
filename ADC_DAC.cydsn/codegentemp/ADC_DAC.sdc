...
# Date: Sat, 15 Apr 2017 11:41:33 GMT
#set_units -time ns
create_clock -name {ADC_REG_CLOCK(routed)} -period 625 -waveform {0 312.5} [list [get_pins {ClockBlock/dclk_1}]]
...
create_generated_clock -name {ADC_REG_CLOCK} -source [get_pins {ClockBlock/clk_sync}] -edges {1 31 61} [list [get_pins {ClockBlock/dclk_glb_1}]]
create_clock -name {ADC_REG_CLOCK(fixed-function)} -period 625 -waveform {0 20.8333333333333} [get_pins {ClockBlock/dclk_glb_ff_1}]
...
# Project: C:\Users\ben\Documents\PSoC Creator\New Pedal Thingz\PSOC_BIT_MANGLER\BIT-MANGLER\ADC_DAC.cydsn\ADC_DAC.cyprj
# Date: Sat, 15 Apr 2017 11:41:09 GMT
