...
#if (!PWM_5_UsingFixedFunction)
    uint8   PWM_5_ReadCounter(void) ;
    uint8 PWM_5_ReadCapture(void) ;

    #if (PWM_5_UseStatus)
            void PWM_5_ClearFIFO(void) ;
    #endif /* (PWM_5_UseStatus) */

    void    PWM_5_WriteCounter(uint8 counter)
            ;
#endif /* (!PWM_5_UsingFixedFunction) */

void    PWM_5_WritePeriod(uint8 period)
        ;
uint8 PWM_5_ReadPeriod(void) ;

#if (PWM_5_UseOneCompareMode)
    void    PWM_5_WriteCompare(uint8 compare)
            ;
    uint8 PWM_5_ReadCompare(void) ;
#else
    void    PWM_5_WriteCompare1(uint8 compare)
            ;
    uint8 PWM_5_ReadCompare1(void) ;
    void    PWM_5_WriteCompare2(uint8 compare)
            ;
    uint8 PWM_5_ReadCompare2(void) ;
#endif /* (PWM_5_UseOneCompareMode) */
...
**************************************/
#define PWM_5_INIT_PERIOD_VALUE          (1u)
...
#define PWM_5_DEFAULT_COMPARE1_MODE      (uint8)((uint8)2u <<  PWM_5_CTRL_CMPMODE1_SHIFT)
...
******************************** */
   ...
   #define PWM_5_RT1_PTR                 ( (reg8 *)  PWM_5_PWMHW__RT1)
       ...
       #if(PWM_5_PWMModeIsCenterAligned)
           #define PWM_5_PERIOD_LSB      (*(reg8 *)  PWM_5_PWMUDB_sP8_pwmdp_u0__D1_REG)
           #define PWM_5_PERIOD_LSB_PTR  ((reg8 *)   PWM_5_PWMUDB_sP8_pwmdp_u0__D1_REG)
       #else
           #define PWM_5_PERIOD_LSB      (*(reg8 *)  PWM_5_PWMUDB_sP8_pwmdp_u0__F0_REG)
           #define PWM_5_PERIOD_LSB_PTR  ((reg8 *)   PWM_5_PWMUDB_sP8_pwmdp_u0__F0_REG)
       #endif /* (PWM_5_PWMModeIsCenterAligned) */

       #define PWM_5_COMPARE1_LSB        (*(reg8 *)  PWM_5_PWMUDB_sP8_pwmdp_u0__D0_REG)
       #define PWM_5_COMPARE1_LSB_PTR    ((reg8 *)   PWM_5_PWMUDB_sP8_pwmdp_u0__D0_REG)
       #define PWM_5_COMPARE2_LSB        (*(reg8 *)  PWM_5_PWMUDB_sP8_pwmdp_u0__D1_REG)
       #define PWM_5_COMPARE2_LSB_PTR    ((reg8 *)   PWM_5_PWMUDB_sP8_pwmdp_u0__D1_REG)
       #define PWM_5_COUNTERCAP_LSB      (*(reg8 *)  PWM_5_PWMUDB_sP8_pwmdp_u0__A1_REG)
       #define PWM_5_COUNTERCAP_LSB_PTR  ((reg8 *)   PWM_5_PWMUDB_sP8_pwmdp_u0__A1_REG)
       #define PWM_5_COUNTER_LSB         (*(reg8 *)  PWM_5_PWMUDB_sP8_pwmdp_u0__A0_REG)
       #define PWM_5_COUNTER_LSB_PTR     ((reg8 *)   PWM_5_PWMUDB_sP8_pwmdp_u0__A0_REG)
       #define PWM_5_CAPTURE_LSB         (*(reg8 *)  PWM_5_PWMUDB_sP8_pwmdp_u0__F1_REG)
       #define PWM_5_CAPTURE_LSB_PTR     ((reg8 *)   PWM_5_PWMUDB_sP8_pwmdp_u0__F1_REG)

   #else
        #if(CY_PSOC3) /* 8-bit address space */
            #if(PWM_5_PWMModeIsCenterAligned)
               #define PWM_5_PERIOD_LSB      (*(reg16 *) PWM_5_PWMUDB_sP8_pwmdp_u0__D1_REG)
               #define PWM_5_PERIOD_LSB_PTR  ((reg16 *)  PWM_5_PWMUDB_sP8_pwmdp_u0__D1_REG)
            #else
               #define PWM_5_PERIOD_LSB      (*(reg16 *) PWM_5_PWMUDB_sP8_pwmdp_u0__F0_REG)
               #define PWM_5_PERIOD_LSB_PTR  ((reg16 *)  PWM_5_PWMUDB_sP8_pwmdp_u0__F0_REG)
            #endif /* (PWM_5_PWMModeIsCenterAligned) */

            #define PWM_5_COMPARE1_LSB       (*(reg16 *) PWM_5_PWMUDB_sP8_pwmdp_u0__D0_REG)
            #define PWM_5_COMPARE1_LSB_PTR   ((reg16 *)  PWM_5_PWMUDB_sP8_pwmdp_u0__D0_REG)
            #define PWM_5_COMPARE2_LSB       (*(reg16 *) PWM_5_PWMUDB_sP8_pwmdp_u0__D1_REG)
            #define PWM_5_COMPARE2_LSB_PTR   ((reg16 *)  PWM_5_PWMUDB_sP8_pwmdp_u0__D1_REG)
            #define PWM_5_COUNTERCAP_LSB     (*(reg16 *) PWM_5_PWMUDB_sP8_pwmdp_u0__A1_REG)
            #define PWM_5_COUNTERCAP_LSB_PTR ((reg16 *)  PWM_5_PWMUDB_sP8_pwmdp_u0__A1_REG)
            #define PWM_5_COUNTER_LSB        (*(reg16 *) PWM_5_PWMUDB_sP8_pwmdp_u0__A0_REG)
            #define PWM_5_COUNTER_LSB_PTR    ((reg16 *)  PWM_5_PWMUDB_sP8_pwmdp_u0__A0_REG)
            #define PWM_5_CAPTURE_LSB        (*(reg16 *) PWM_5_PWMUDB_sP8_pwmdp_u0__F1_REG)
            #define PWM_5_CAPTURE_LSB_PTR    ((reg16 *)  PWM_5_PWMUDB_sP8_pwmdp_u0__F1_REG)
        #else
            #if(PWM_5_PWMModeIsCenterAligned)
               #define PWM_5_PERIOD_LSB      (*(reg16 *) PWM_5_PWMUDB_sP8_pwmdp_u0__16BIT_D1_REG)
               #define PWM_5_PERIOD_LSB_PTR  ((reg16 *)  PWM_5_PWMUDB_sP8_pwmdp_u0__16BIT_D1_REG)
            #else
               #define PWM_5_PERIOD_LSB      (*(reg16 *) PWM_5_PWMUDB_sP8_pwmdp_u0__16BIT_F0_REG)
               #define PWM_5_PERIOD_LSB_PTR  ((reg16 *)  PWM_5_PWMUDB_sP8_pwmdp_u0__16BIT_F0_REG)
            #endif /* (PWM_5_PWMModeIsCenterAligned) */

            #define PWM_5_COMPARE1_LSB       (*(reg16 *) PWM_5_PWMUDB_sP8_pwmdp_u0__16BIT_D0_REG)
            #define PWM_5_COMPARE1_LSB_PTR   ((reg16 *)  PWM_5_PWMUDB_sP8_pwmdp_u0__16BIT_D0_REG)
            #define PWM_5_COMPARE2_LSB       (*(reg16 *) PWM_5_PWMUDB_sP8_pwmdp_u0__16BIT_D1_REG)
            #define PWM_5_COMPARE2_LSB_PTR   ((reg16 *)  PWM_5_PWMUDB_sP8_pwmdp_u0__16BIT_D1_REG)
            #define PWM_5_COUNTERCAP_LSB     (*(reg16 *) PWM_5_PWMUDB_sP8_pwmdp_u0__16BIT_A1_REG)
            #define PWM_5_COUNTERCAP_LSB_PTR ((reg16 *)  PWM_5_PWMUDB_sP8_pwmdp_u0__16BIT_A1_REG)
            #define PWM_5_COUNTER_LSB        (*(reg16 *) PWM_5_PWMUDB_sP8_pwmdp_u0__16BIT_A0_REG)
            #define PWM_5_COUNTER_LSB_PTR    ((reg16 *)  PWM_5_PWMUDB_sP8_pwmdp_u0__16BIT_A0_REG)
            #define PWM_5_CAPTURE_LSB        (*(reg16 *) PWM_5_PWMUDB_sP8_pwmdp_u0__16BIT_F1_REG)
            #define PWM_5_CAPTURE_LSB_PTR    ((reg16 *)  PWM_5_PWMUDB_sP8_pwmdp_u0__16BIT_F1_REG)
        #endif /* (CY_PSOC3) */

       #define PWM_5_AUX_CONTROLDP1          (*(reg8 *)  PWM_5_PWMUDB_sP8_pwmdp_u1__DP_AUX_CTL_REG)
       #define PWM_5_AUX_CONTROLDP1_PTR      ((reg8 *)   PWM_5_PWMUDB_sP8_pwmdp_u1__DP_AUX_CTL_REG)

   #endif /* (PWM_5_Resolution == 8) */

   #define PWM_5_COUNTERCAP_LSB_PTR_8BIT ( (reg8 *)  PWM_5_PWMUDB_sP8_pwmdp_u0__A1_REG)
   #define PWM_5_AUX_CONTROLDP0          (*(reg8 *)  PWM_5_PWMUDB_sP8_pwmdp_u0__DP_AUX_CTL_REG)
   #define PWM_5_AUX_CONTROLDP0_PTR      ((reg8 *)   PWM_5_PWMUDB_sP8_pwmdp_u0__DP_AUX_CTL_REG)
