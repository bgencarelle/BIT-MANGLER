...
#ifdef PWM_6_PWMUDB_genblk1_ctrlreg__REMOVED
    #error PWM_v3_30 detected with a constant 0 for the enable or \
         constant 1 for reset. This will prevent the component from operating.
#endif /* PWM_6_PWMUDB_genblk1_ctrlreg__REMOVED */
...
void PWM_6_Init(void) 
{
        ...
        ctrl = PWM_6_CONTROL & ((uint8)(~PWM_6_CTRL_CMPMODE2_MASK)) &
                ((uint8)(~PWM_6_CTRL_CMPMODE1_MASK));
...
void PWM_6_Stop(void) 
{
    ...
    /* Globally disable the Fixed Function Block chosen */
        ...
        *******************************************************************************/
        void PWM_6_SetCompareMode(uint8 comparemode) 
        {
                ...
                /*Clear existing mode */
                PWM_6_CONTROL &= ((uint8)(~(PWM_6_CTRL_CMPMODE1_MASK |
                                            PWM_6_CTRL_CMPMODE2_MASK)));
    ...
    *******************************************************************************/
    ...
    {
        CY_SET_REG8(PWM_6_COUNTER_LSB_PTR, counter);
    }
    ...
    *******************************************************************************/
    uint8 PWM_6_ReadCounter(void) 
    {
        ...
        /* It is up to the user code to make sure there isn't already captured data in the FIFO */
          (void)CY_GET_REG8(PWM_6_COUNTERCAP_LSB_PTR_8BIT);

        /* Read the data from the FIFO */
        return (CY_GET_REG8(PWM_6_CAPTURE_LSB_PTR));
    }
...
void PWM_6_WritePeriod(uint8 period) 
{
    ...
    #else
        CY_SET_REG8(PWM_6_PERIOD_LSB_PTR, period);
    #endif /* (PWM_6_UsingFixedFunction) */
}
    ...
    *******************************************************************************/
                                       ...
                                       
    {
        ...
        #else
            CY_SET_REG8(PWM_6_COMPARE1_LSB_PTR, compare);
        #endif /* (PWM_6_UsingFixedFunction) */
            ...
            #else
                CY_SET_REG8(PWM_6_COMPARE2_LSB_PTR, (compare + 1u));
            #endif /* (PWM_6_UsingFixedFunction) */
    ...
    *******************************************************************************/
                                        ...
                                        
    {
        ...
        #else
            CY_SET_REG8(PWM_6_COMPARE2_LSB_PTR, compare);
        #endif /* (PWM_6_UsingFixedFunction) */
    }
#endif /* UseOneCompareMode */
    ...
    *******************************************************************************/
    ...
    {
        return (CY_GET_REG8(PWM_6_STATUS_PTR));
    }
    ...
    *******************************************************************************/
    ...
    {
        #if(PWM_6_UsingFixedFunction)
            return ((uint8)CY_GET_REG16(PWM_6_COMPARE1_LSB_PTR));
        #else
            return (CY_GET_REG8(PWM_6_COMPARE1_LSB_PTR));
        #endif /* (PWM_6_UsingFixedFunction) */
    }
    ...
    *******************************************************************************/
    ...
    {
        return (CY_GET_REG8(PWM_6_COMPARE2_LSB_PTR));
    }
...
{
    #if(PWM_6_UsingFixedFunction)
        return ((uint8)CY_GET_REG16(PWM_6_PERIOD_LSB_PTR));
    #else
        return (CY_GET_REG8(PWM_6_PERIOD_LSB_PTR));
    #endif /* (PWM_6_UsingFixedFunction) */
}
