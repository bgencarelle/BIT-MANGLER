...
#define ADC_SAR_Seq_NUMBER_OF_CHANNELS    (4u)
#define ADC_SAR_Seq_SAMPLE_MODE           (0u)
#define ADC_SAR_Seq_CLOCK_SOURCE          (1u)
...
#define ADC_SAR_Seq_FINAL_BYTES_PER_BURST    ((uint16)ADC_SAR_Seq_NUMBER_OF_CHANNELS << 1u)
...
#define ADC_SAR_Seq_CLOCK_INTERNAL              (0x00u)
#define ADC_SAR_Seq_CLOCK_EXTERNAL              (0x01u)
