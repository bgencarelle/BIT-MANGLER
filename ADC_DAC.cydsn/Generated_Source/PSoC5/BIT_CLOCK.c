...
*
*******************************************************************************/
void BIT_CLOCK_Start(void) 
{
    /* Set the bit to enable the clock. */
    BIT_CLOCK_CLKEN |= BIT_CLOCK_CLKEN_MASK;
	BIT_CLOCK_CLKSTBY |= BIT_CLOCK_CLKSTBY_MASK;
}


/*******************************************************************************
* Function Name: BIT_CLOCK_Stop
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void BIT_CLOCK_Stop(void) 
{
    /* Clear the bit to disable the clock. */
    BIT_CLOCK_CLKEN &= (uint8)(~BIT_CLOCK_CLKEN_MASK);
	BIT_CLOCK_CLKSTBY &= (uint8)(~BIT_CLOCK_CLKSTBY_MASK);
}
...
/*******************************************************************************
* Function Name: BIT_CLOCK_StopBlock
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void BIT_CLOCK_StopBlock(void) 
{
    if ((BIT_CLOCK_CLKEN & BIT_CLOCK_CLKEN_MASK) != 0u)
    {
...
#if defined(BIT_CLOCK__CFG3)
        CLK_DIST_AMASK = BIT_CLOCK_CLKEN_MASK;
        CLK_DIST_DMASK = 0x00u;
#else
        CLK_DIST_DMASK = BIT_CLOCK_CLKEN_MASK;
        CLK_DIST_AMASK = 0x00u;
#endif /* BIT_CLOCK__CFG3 */

        /* Clear mask of bus clock. */
        CLK_DIST_BCFG2 &= (uint8)(~BCFG2_MASK);

        oldDivider = CY_GET_REG16(BIT_CLOCK_DIV_PTR);
        ...
        CLK_DIST_LD = 0x00u;
        CY_SET_REG16(BIT_CLOCK_DIV_PTR, oldDivider);
#endif /* HAS_CLKDIST_LD_DISABLE */
    }
}
...
/*******************************************************************************
* Function Name: BIT_CLOCK_StandbyPower
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void BIT_CLOCK_StandbyPower(uint8 state) 
{
    if(state == 0u)
    {
        BIT_CLOCK_CLKSTBY &= (uint8)(~BIT_CLOCK_CLKSTBY_MASK);
...
/*******************************************************************************
* Function Name: BIT_CLOCK_SetDividerRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void BIT_CLOCK_SetDividerRegister(uint16 clkDivider, uint8 restart)
                                
{
    uint8 enabled;

    uint8 currSrc = BIT_CLOCK_GetSourceRegister();
    uint16 oldDivider = BIT_CLOCK_GetDividerRegister();

    if (clkDivider != oldDivider)
    {
        enabled = BIT_CLOCK_CLKEN & BIT_CLOCK_CLKEN_MASK;
        ...
        else
        {
            ...
            if (enabled != 0u)
            {
                ...
                if (((BIT_CLOCK_MOD_SRC & CYCLK_SYNC) == 0u) || (clkDivider == 0u))
                {
#if HAS_CLKDIST_LD_DISABLE
                    CY_SET_REG16(CYREG_CLKDIST_WRK0, oldDivider);
                    CLK_DIST_LD = CYCLK_LD_DISABLE|CYCLK_LD_SYNC_EN|CYCLK_LD_LOAD;
...
/*******************************************************************************
* Function Name: BIT_CLOCK_GetDividerRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint16 BIT_CLOCK_GetDividerRegister(void) 
{
    return CY_GET_REG16(BIT_CLOCK_DIV_PTR);
}


/*******************************************************************************
* Function Name: BIT_CLOCK_SetModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void BIT_CLOCK_SetModeRegister(uint8 modeBitMask) 
{
    BIT_CLOCK_MOD_SRC |= modeBitMask & (uint8)BIT_CLOCK_MODE_MASK;
}


/*******************************************************************************
* Function Name: BIT_CLOCK_ClearModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void BIT_CLOCK_ClearModeRegister(uint8 modeBitMask) 
{
    BIT_CLOCK_MOD_SRC &= (uint8)(~modeBitMask) | (uint8)(~(uint8)(BIT_CLOCK_MODE_MASK));
}


/*******************************************************************************
* Function Name: BIT_CLOCK_GetModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 BIT_CLOCK_GetModeRegister(void) 
{
    return BIT_CLOCK_MOD_SRC & (uint8)(BIT_CLOCK_MODE_MASK);
}


/*******************************************************************************
* Function Name: BIT_CLOCK_SetSourceRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void BIT_CLOCK_SetSourceRegister(uint8 clkSource) 
{
    uint16 currDiv = BIT_CLOCK_GetDividerRegister();
    uint8 oldSrc = BIT_CLOCK_GetSourceRegister();
        ...
        (clkSource == ((uint8)CYCLK_SRC_SEL_CLK_SYNC_D))) && (currDiv == 0u))
    {
        ...
        BIT_CLOCK_MOD_SRC |= CYCLK_SSS;
        BIT_CLOCK_MOD_SRC =
            (BIT_CLOCK_MOD_SRC & (uint8)(~BIT_CLOCK_SRC_SEL_MSK)) | clkSource;
    }
...
/*******************************************************************************
* Function Name: BIT_CLOCK_GetSourceRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 BIT_CLOCK_GetSourceRegister(void) 
{
    return BIT_CLOCK_MOD_SRC & BIT_CLOCK_SRC_SEL_MSK;
}
...
/*******************************************************************************
* Function Name: BIT_CLOCK_SetPhaseRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void BIT_CLOCK_SetPhaseRegister(uint8 clkPhase) 
{
    BIT_CLOCK_PHASE = clkPhase & BIT_CLOCK_PHASE_MASK;
}


/*******************************************************************************
* Function Name: BIT_CLOCK_GetPhase
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 BIT_CLOCK_GetPhaseRegister(void) 
{
    return BIT_CLOCK_PHASE & BIT_CLOCK_PHASE_MASK;
}
