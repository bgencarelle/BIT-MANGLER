...
*
* \funcusage
*  \snippet DELSIG_IN_SUT.c usage_DELSIG_IN_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet DELSIG_IN_SUT.c usage_DELSIG_IN_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet DELSIG_IN_SUT.c usage_DELSIG_IN_Read  
*******************************************************************************/
...
* preferred DELSIG_IN_Read() API because the 
* DELSIG_IN_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet DELSIG_IN_SUT.c usage_DELSIG_IN_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: DELSIG_IN_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use DELSIG_IN_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - DELSIG_IN_0_INTR       (First pin in the list)
    *  - DELSIG_IN_1_INTR       (Second pin in the list)
    *  - ...
    *  - DELSIG_IN_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet DELSIG_IN_SUT.c usage_DELSIG_IN_SetInterruptMode
    *******************************************************************************/
    void DELSIG_IN_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & DELSIG_IN_0_INTR) != 0u) 
		{ 
			 DELSIG_IN_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet DELSIG_IN_SUT.c usage_DELSIG_IN_ClearInterrupt
    *******************************************************************************/
