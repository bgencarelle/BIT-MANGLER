...
#define CapSense_1_TOTAL_SENSOR_COUNT            (8u)
#define CapSense_1_TOTAL_SCANSLOT_COUNT            (8u)
#define CapSense_1_TOTAL_RB_NUMBER            (1u)
#define CapSense_1_TOTAL_RB_NUMBER__CH0            (1u)

/* Define Sensors */
#define CapSense_1_SENSOR_GENERIC0_0__GEN    (0u)
#define CapSense_1_SENSOR_LINEARSLIDER0_E0__LS    (1u)
#define CapSense_1_SENSOR_LINEARSLIDER0_E1__LS    (2u)
#define CapSense_1_SENSOR_LINEARSLIDER0_E2__LS    (3u)
#define CapSense_1_SENSOR_LINEARSLIDER0_E3__LS    (4u)
#define CapSense_1_SENSOR_LINEARSLIDER0_E4__LS    (5u)
#define CapSense_1_SENSOR_BUTTON0__BTN    (6u)
#define CapSense_1_SENSOR_BUTTON1__BTN    (7u)
/* AMux Cmod, Comparator and Idac Channels definitions */
#define CapSense_1_AMuxCH0_CMOD_CHANNEL          (8u)
#define CapSense_1_AMuxCH0_CMP_VP_CHANNEL        (9u)
#define CapSense_1_AMuxCH0_IDAC_CHANNEL          (10u)
