...
void PWM_5_Stop(void) 
{
    ...
    *******************************************************************************/
    ...
    {
        CY_SET_REG8(PWM_5_COUNTER_LSB_PTR, counter);
    }
    ...
    *******************************************************************************/
    uint8 PWM_5_ReadCounter(void) 
    {
        ...
        return (CY_GET_REG8(PWM_5_CAPTURE_LSB_PTR));
    }
...
void PWM_5_WritePeriod(uint8 period) 
{
    ...
    #else
        CY_SET_REG8(PWM_5_PERIOD_LSB_PTR, period);
    #endif /* (PWM_5_UsingFixedFunction) */
}
    ...
    *******************************************************************************/
                                       ...
                                       
    {
        ...
        #else
            CY_SET_REG8(PWM_5_COMPARE1_LSB_PTR, compare);
        #endif /* (PWM_5_UsingFixedFunction) */
            ...
            #else
                CY_SET_REG8(PWM_5_COMPARE2_LSB_PTR, (compare + 1u));
            #endif /* (PWM_5_UsingFixedFunction) */
    ...
    *******************************************************************************/
                                        ...
                                        
    {
        ...
        #else
            CY_SET_REG8(PWM_5_COMPARE2_LSB_PTR, compare);
        #endif /* (PWM_5_UsingFixedFunction) */
    }
#endif /* UseOneCompareMode */
    ...
    *******************************************************************************/
    ...
    {
        #if(PWM_5_UsingFixedFunction)
            return ((uint8)CY_GET_REG16(PWM_5_COMPARE1_LSB_PTR));
        #else
            return (CY_GET_REG8(PWM_5_COMPARE1_LSB_PTR));
        #endif /* (PWM_5_UsingFixedFunction) */
    }
    ...
    *******************************************************************************/
    ...
    {
        return (CY_GET_REG8(PWM_5_COMPARE2_LSB_PTR));
    }
...
{
    #if(PWM_5_UsingFixedFunction)
        return ((uint8)CY_GET_REG16(PWM_5_PERIOD_LSB_PTR));
    #else
        return (CY_GET_REG8(PWM_5_PERIOD_LSB_PTR));
    #endif /* (PWM_5_UsingFixedFunction) */
}
