...
#define SCCT_Comp_1_SCCMPCLK_SetDivider(clkDivider)         SCCT_Comp_1_SCCMPCLK_SetDividerRegister(clkDivider, 1u)
#define SCCT_Comp_1_SCCMPCLK_SetDividerValue(clkDivider)    SCCT_Comp_1_SCCMPCLK_SetDividerRegister((clkDivider) - 1u, 1u)
...
#define SCCT_Comp_1_SCCMPCLK_SetPhaseValue(clkPhase)        SCCT_Comp_1_SCCMPCLK_SetPhaseRegister((clkPhase) + 1u)
#endif /* defined(SCCT_Comp_1_SCCMPCLK__CFG3) */
