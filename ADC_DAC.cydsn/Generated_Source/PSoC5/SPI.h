...
void  SPI_WriteTxData(uint16 txData)  \
                                                            ;
...
void  SPI_PutArray(const uint16 buffer[], uint8 byteCount) \
                                                            ;
...
***************************************/
    ...
    #define SPI_TXDATA_REG (* (reg16 *) \
                                                SPI_BSPIM_sR16_Dp_u0__F0_REG)
    #define SPI_TXDATA_PTR (  (reg16 *) \
                                                SPI_BSPIM_sR16_Dp_u0__F0_REG)
    #define SPI_RXDATA_REG (* (reg16 *) \
                                                SPI_BSPIM_sR16_Dp_u0__F1_REG)
    #define SPI_RXDATA_PTR (  (reg16 *) \
                                                SPI_BSPIM_sR16_Dp_u0__F1_REG)
#else   /* PSOC4 */
    #if(SPI_USE_SECOND_DATAPATH)
        #define SPI_TXDATA_REG (* (reg16 *) \
                                          SPI_BSPIM_sR16_Dp_u0__16BIT_F0_REG)
        #define SPI_TXDATA_PTR (  (reg16 *) \
                                          SPI_BSPIM_sR16_Dp_u0__16BIT_F0_REG)
        #define SPI_RXDATA_REG (* (reg16 *) \
                                          SPI_BSPIM_sR16_Dp_u0__16BIT_F1_REG)
        #define SPI_RXDATA_PTR (  (reg16 *) \
                                          SPI_BSPIM_sR16_Dp_u0__16BIT_F1_REG)
    #else
...
#define SPI_AUX_CONTROL_DP0_REG (* (reg8 *) \
                                        SPI_BSPIM_sR16_Dp_u0__DP_AUX_CTL_REG)
#define SPI_AUX_CONTROL_DP0_PTR (  (reg8 *) \
                                        SPI_BSPIM_sR16_Dp_u0__DP_AUX_CTL_REG)

#if(SPI_USE_SECOND_DATAPATH)
    #define SPI_AUX_CONTROL_DP1_REG  (* (reg8 *) \
                                        SPI_BSPIM_sR16_Dp_u1__DP_AUX_CTL_REG)
