...
#define ScanComp_1_INTERNAL_REF_USED      (1u)
...
#define ScanComp_1_INTERNAL_REF_IS_USED   ((CY_PSOC3 || CY_PSOC5) &&  \
    ...
    #define ScanComp_1_DEFAULT_VOLTAGE        (125u)
...
***************************************/
#define ScanComp_1_NUM_OF_CHANNELS                (8u)
#define ScanComp_1_DEFAULT_CHANNELS_VAL           (8u - 1u)
