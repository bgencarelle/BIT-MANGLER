...
#ifdef PWM_7_PWMUDB_genblk1_ctrlreg__REMOVED
    #error PWM_v3_30 detected with a constant 0 for the enable or \
         constant 1 for reset. This will prevent the component from operating.
#endif /* PWM_7_PWMUDB_genblk1_ctrlreg__REMOVED */
...
void PWM_7_Init(void) 
{
        ...
        ctrl = PWM_7_CONTROL & ((uint8)(~PWM_7_CTRL_CMPMODE2_MASK)) &
                ((uint8)(~PWM_7_CTRL_CMPMODE1_MASK));
...
void PWM_7_Stop(void) 
{
    ...
    /* Globally disable the Fixed Function Block chosen */
        ...
        *******************************************************************************/
        void PWM_7_SetCompareMode(uint8 comparemode) 
        {
                ...
                /*Clear existing mode */
                PWM_7_CONTROL &= ((uint8)(~(PWM_7_CTRL_CMPMODE1_MASK |
                                            PWM_7_CTRL_CMPMODE2_MASK)));
    ...
    *******************************************************************************/
    ...
    {
        CY_SET_REG8(PWM_7_COUNTER_LSB_PTR, counter);
    }
    ...
    *******************************************************************************/
    uint8 PWM_7_ReadCounter(void) 
    {
        ...
        /* It is up to the user code to make sure there isn't already captured data in the FIFO */
          (void)CY_GET_REG8(PWM_7_COUNTERCAP_LSB_PTR_8BIT);

        /* Read the data from the FIFO */
        return (CY_GET_REG8(PWM_7_CAPTURE_LSB_PTR));
    }
...
void PWM_7_WritePeriod(uint8 period) 
{
    ...
    #else
        CY_SET_REG8(PWM_7_PERIOD_LSB_PTR, period);
    #endif /* (PWM_7_UsingFixedFunction) */
}
    ...
    *******************************************************************************/
                                       ...
                                       
    {
        ...
        #else
            CY_SET_REG8(PWM_7_COMPARE1_LSB_PTR, compare);
        #endif /* (PWM_7_UsingFixedFunction) */
            ...
            #else
                CY_SET_REG8(PWM_7_COMPARE2_LSB_PTR, (compare + 1u));
            #endif /* (PWM_7_UsingFixedFunction) */
    ...
    *******************************************************************************/
                                        ...
                                        
    {
        ...
        #else
            CY_SET_REG8(PWM_7_COMPARE2_LSB_PTR, compare);
        #endif /* (PWM_7_UsingFixedFunction) */
    }
#endif /* UseOneCompareMode */
    ...
    *******************************************************************************/
    ...
    {
        return (CY_GET_REG8(PWM_7_STATUS_PTR));
    }
    ...
    *******************************************************************************/
    ...
    {
        #if(PWM_7_UsingFixedFunction)
            return ((uint8)CY_GET_REG16(PWM_7_COMPARE1_LSB_PTR));
        #else
            return (CY_GET_REG8(PWM_7_COMPARE1_LSB_PTR));
        #endif /* (PWM_7_UsingFixedFunction) */
    }
    ...
    *******************************************************************************/
    ...
    {
        return (CY_GET_REG8(PWM_7_COMPARE2_LSB_PTR));
    }
...
{
    #if(PWM_7_UsingFixedFunction)
        return ((uint8)CY_GET_REG16(PWM_7_PERIOD_LSB_PTR));
    #else
        return (CY_GET_REG8(PWM_7_PERIOD_LSB_PTR));
    #endif /* (PWM_7_UsingFixedFunction) */
}
